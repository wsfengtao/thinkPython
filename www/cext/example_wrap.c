...
SWIGINTERN PyObject *_wrap_fact2(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  char *arg1 = (char *) 0 ;
  int res1 ;
  char *buf1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:fact2",&obj0)) SWIG_fail;
  res1 = SWIG_AsCharPtrAndSize(obj0, &buf1, NULL, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "fact2" "', argument " "1"" of type '" "char *""'");
  }
  arg1 = (char *)(buf1);
  result = (char *)fact2(arg1);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"fact2", _wrap_fact2, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
